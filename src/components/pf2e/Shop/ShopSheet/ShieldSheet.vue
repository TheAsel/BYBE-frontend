  ...
  >
    <div class="tw:my-auto!">
      <q-btn
        ...
        @click="
          openShopSheet(items.getSelectedItem?.game ?? 'pf', items.getSelectedItem!.core_item.id)
        "
      >
        <q-tooltip
    ...
    <q-space />
    <div class="tw:my-1">Shield {{ items.getSelectedItem!.core_item.level }}</div>
    <div class="tw:my-auto!">
      <q-btn
