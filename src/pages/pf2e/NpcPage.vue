...
import NpcEditor from '../../components/pf2e/NPC/NpcEditor.vue';
import NpcGenerator from '../../components/pf2e/NPC/NpcGenerator.vue';
import NpcSheet from '../../components/pf2e/NPC/NpcSheet.vue';
...
useHead({
  ...
  link: [
    {
      rel: 'canonical',
      href: 'https://bybe.fly.dev/pf2e/npc'
    }
  ]
});
...
<template>
  <div class="row items-center justify-between">
    <v-tour name="/pf2e/npc" :steps="steps" :options="options" :callbacks="callbacks" />
